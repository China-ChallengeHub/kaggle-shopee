"""This script took from:
https://www.kaggle.com/tanulsingh077/metric-learning-image-tfidf-inference?scriptVersionId=57597192
"""
...
IMG_MODEL_PATH = "../input/pytorchmetriclearning001/model_efficientnet_b0_IMG_SIZE_512_arcface.bin"
...
def get_neighbors(df, embeddings, KNN=50, image=True):
    ...
    if GET_CV:
        ...
        max_score = thresholds_scores[
            thresholds_scores["scores"] == thresholds_scores["scores"].max()
        ]

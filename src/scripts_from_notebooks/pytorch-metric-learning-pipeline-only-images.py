"""
Script took from https://www.kaggle.com/tanulsingh077/metric-learning-image-tfidf-inference?scriptVersionId=57597192
"""
import math
import os
import random
...
def run():
    ...
    for epoch in range(EPOCHS):
        ...
        if valid_loss.avg < best_loss:
            ...
            torch.save(
                model.state_dict(), f"model_{model_name}_IMG_SIZE_{DIM[0]}_{loss_module}.bin"
            )
